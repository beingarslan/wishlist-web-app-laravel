        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-12 p-2 shadow-hover">
              ...
              <div class="card product-card border-0 " data-bs-toggle="modal" data-bs-target="#aboutcard-{{$wish->id}}">
                  ...
                  <div class="product-rating small text-alternate text-end">
                      <button class="rounded-circle-left rounded-circle-right btn btn-outline-success border-0 p-2 text-uppercase ms-auto">share <i
        ...
        @endforeach
          ...
          {{-- <div class="col-lg-3 col-md-3 col-sm-6 col-12 p-2 shadow-hover">
              <div class="card product-card border-0">
                  ...
                  <div class="product-rating small text-alternate text-end">
                      <button class="rounded-circle-left rounded-circle-right btn btn-outline-light text-success border-0 p-2 text-uppercase ms-auto">share <i
                              class="fas fa-sad-tear ms-2"></i></button>
