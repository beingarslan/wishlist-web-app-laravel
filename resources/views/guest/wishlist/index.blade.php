...
<header class="header section mt-5 header section text-contrast  overlay-primary  parallax cover">
    <div class="cover-img relative ">
        ...
        <div class="img-btn position-absolute">
            ...
            {{-- <form action="{{ route('user.upload-cover-image')}}" method="POST" enctype="multipart/form-data" >
            @csrf
            <div style='height: 0px;width: 0px; overflow:hidden;'>
                <input type="file" id="fileInput" name="fileInput" onchange="this.form.submit()" capture />
            </div>
            <div id="yourBtn">
                <button class="fs-6 m-0 btn btn-primary btn-circle">
                    <i class="fas fa-camera-retro" onclick="fileInput.click();"></i>
                </button>
            </div>
            </form> --}}
    ...
    <div class="profile-img relative">
        <div class="row mt-n8  justify-content-center ">
            <div class="col-md-2 order-1">
                <div class="">
                    @if(!$user->avatar)
                    <img class="img img-fluid img-thumbnail rounded-pill" width="218px" height="218px" src="{{ asset('front-end/img/avatar/5.jpg')}}" alt="">
                    @else
    ...
    <div class="d-flex my-5 container">
        ...
        <div class="ms-auto">
            <button data-bs-toggle="modal" data-bs-target="#editModel" class="btn btn-primary py-2 text-capitalize text-center align-items-center">Edit
                profile</button>
        </div>
    ...
    <div class="container py-2 text-center text-md-start">
        <div class="row">
            ...
            <div class="col-md-6 text-end my-auto p-0">
                <a href="#" class="btn btn-rounded ms-n2">Set up payments <i class="m-0 fa fa-arrow-right"></i></a>
...
<section class="section section-wishes">
    <div class="container p-2 d-block d-md-flex">
        ...
        <div class="ms-auto my-auto btns">
            ...
            <button type="button" class="btn btn-rounded btn-outline-primary" data-bs-toggle="modal" data-bs-target="#addWishModel">
                ADD A WISH
            </button>
        </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="my-2">
                                ...
                                <div class="image-preview text-center">
                                    <input class="form-control" type="file" onchange="readURL(this)" name="image" data-update="yes" id="formFileMultiple" class="image-input" accept="image/*" />
                                </div>
                            </div>
                            <br>
                            <div class="my-2">
              ...
              class="btn btn-primary py-2 text-capitalize text-center align-items-center"-->
                ...
                <div class="modal fade" id="aboutcard-{{$wish->id}}" tabindex="-1" aria-labelledby="aboutcard" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title text-capitalize text-info m-auto" id="exampleModalLabel ">edit wish</h5>
                                <button type="button" class="btn-close btn-info" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div>
                                <form id="edit-wish-form" action="{{ route('guest.wishlist.update') }}" method="POST" enctype="multipart/form-data" class="align-content-center justify-content-between flex-column overflow-y text-center">
                                    @csrf
                                        ...
                                        <div class="container py-2">
                                            ...
                                            <div class="image-preview text-center">
                                                ...
                                                <div class="image-updated  mt-3 ">
                                                    <img src="{{ asset( $wish->image) }}" alt="" class="mh-15 w-25">
                                                </div>
                                            </div>
                                        </div>
                                        {{-- <div>
                                    ...
                                    <div>
                                        <div class="container py-2 text-start">
                                            <div class="text-black mx-2" style="font-family: Nunito, Roboto, 'Helvetica Neue', Arial, sans-serif;">
                                                @if($wish->repeat)
                                        ...
                                        <div class="text-end py-3 container">
                                            <button type="submit" value='submit' class="btn btn-info btn-lg ms-auto border-0 text-uppercase form-control">Update</button>
                                        </div>
                                    </div>
                            </div>
                            </form>
                            <div class="text-end">
                                <form action="{{route('guest.wishlist.destroy')}}" method="post">
                                    ...
                                    <button type="submit" class="btn btn-outline-info ms-auto border-0 text-uppercase" id="delete-{{$wish->id}}">Delete
                                        Wish</button>
                                </form>
                            </div>
