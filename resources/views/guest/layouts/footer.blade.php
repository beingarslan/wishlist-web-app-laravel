<footer class="site-footer section" style="background-color: #def4fd;">
  <div class="w-90 m-auto pb-3">
      <div class="row gap-y text-center text-md-start">
          ...
          <div class="col-md-2">
              <h6 class="py-2 bold text-uppercase">Info</h6>
              <nav class="nav flex-column">
                  <a class="nav-item py-2" href="#">Terms of Service</a>
                  <a class="nav-item py-2" href="#">Privacy Policy</a>
                  <a class="nav-item py-2" href="#">How it works</a>
                  <a class="nav-item py-2" href="#">Frequently Asked Questions</a>
                  </nav>
          </div>
          <div class="col-md-2">
...
{{-- <footer class="site-footer section bg-white">
    <div class="container pb-3">
        <div class="row gap-y text-center text-md-start">
            <div class="col-md-4 me-auto"><img src="{{ asset('front-end/img/logo.png')}}" alt="" class="logo">
