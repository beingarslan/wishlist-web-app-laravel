...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "JsonRequestError": function() { return /* reexport safe */ _internal_common_js__WEBPACK_IMPORTED_MODULE_0__.a9; },
/* harmony export */   "createPlugin": function() { return /* reexport safe */ _internal_common_js__WEBPACK_IMPORTED_MODULE_0__.a8; },
...
theme, viewSpecs, calendarApi) {
    ...
    let widgets = sectionSubstrs.map((buttonGroupStr) => (buttonGroupStr.split(',').map((buttonName) => {
        ...
        if ((customButtonProps = calendarCustomButtons[buttonName])) {
            ...
            buttonHint = (0,_internal_common_js__WEBPACK_IMPORTED_MODULE_0__.f)(viewSpec.buttonTitleOverride ||
            ...
            if (buttonName === 'prevYear' || buttonName === 'nextYear') {
                ...
                buttonHint = (0,_internal_common_js__WEBPACK_IMPORTED_MODULE_0__.f)(calendarButtonHintOverrides[prevOrNext] ||
                ...
                buttonHint = (navUnit) => (0,_internal_common_js__WEBPACK_IMPORTED_MODULE_0__.f)(calendarButtonHintOverrides[buttonName] ||
...
class CalendarDataManager {
    ...
    processRawCalendarOptions(optionOverrides, dynamicOptionOverrides) {
        let { locales, locale } = (0,_internal_common_js__WEBPACK_IMPORTED_MODULE_0__.y)([
        ...
        let extra = {};
        let raw = (0,_internal_common_js__WEBPACK_IMPORTED_MODULE_0__.y)([
            _internal_common_js__WEBPACK_IMPORTED_MODULE_0__.B,
            localeDefaults,
            optionOverrides,
            dynamicOptionOverrides,
        ...
        for (let optionName in raw) {
            if (optionName !== 'plugins') { // because plugins is special-cased
                if (raw[optionName] === currentRaw[optionName] ||
                    (_internal_common_js__WEBPACK_IMPORTED_MODULE_0__.H[optionName] &&
                        (optionName in currentRaw) &&
                        _internal_common_js__WEBPACK_IMPORTED_MODULE_0__.H[optionName](currentRaw[optionName], raw[optionName]))) {
    ...
    processRawViewOptions(viewSpec, pluginHooks, localeDefaults, optionOverrides, dynamicOptionOverrides) {
        ...
        for (let optionName in raw) {
            if (raw[optionName] === currentRaw[optionName] ||
                (_internal_common_js__WEBPACK_IMPORTED_MODULE_0__.H[optionName] &&
                    _internal_common_js__WEBPACK_IMPORTED_MODULE_0__.H[optionName](raw[optionName], currentRaw[optionName]))) {
                refined[optionName] = currentRefined[optionName];
            }
            else {
                if (raw[optionName] === this.currentCalendarOptionsInput[optionName] ||
                    (_internal_common_js__WEBPACK_IMPORTED_MODULE_0__.H[optionName] &&
                        _internal_common_js__WEBPACK_IMPORTED_MODULE_0__.H[optionName](raw[optionName], this.currentCalendarOptionsInput[optionName]))) {
...
class EventClicking extends _internal_common_js__WEBPACK_IMPORTED_MODULE_0__.P {
    constructor(settings) {
        ...
        this.destroy = (0,_internal_common_js__WEBPACK_IMPORTED_MODULE_0__.U)(settings.el, 'click', '.fc-event', // on both fg and bg events
        this.handleSegClick);
    }
}
...
class EventHovering extends _internal_common_js__WEBPACK_IMPORTED_MODULE_0__.P {
    constructor(settings) {
        ...
        this.handleSegEnter = (ev, segEl) => {
            if ((0,_internal_common_js__WEBPACK_IMPORTED_MODULE_0__.Q)(segEl)) { // TODO: better way to make sure not hovering over more+ link or its wrapper
        ...
        this.removeHoverListeners = (0,_internal_common_js__WEBPACK_IMPORTED_MODULE_0__.W)(settings.el, '.fc-event', // on both fg and bg events
...
class CalendarContent extends _internal_common_js__WEBPACK_IMPORTED_MODULE_0__.X {
    ...
    */
    render() {
        ...
        let toolbarProps = this.buildToolbarProps(props.viewSpec, props.dateProfile, props.dateProfileGenerator, props.currentDate, (0,_internal_common_js__WEBPACK_IMPORTED_MODULE_0__.a0)(props.options.now, props.dateEnv), // TODO: use NowTimer????
        props.viewTitle);
        let viewVGrow = false;
        let viewHeight = '';
        let viewAspectRatio;
        ...
        this.handleRenderRequest = () => {
            if (this.isRendering) {
                ...
                (0,_internal_common_js__WEBPACK_IMPORTED_MODULE_0__.a2)(() => {
                    (0,preact__WEBPACK_IMPORTED_MODULE_1__.render)((0,preact__WEBPACK_IMPORTED_MODULE_1__.createElement)(_internal_common_js__WEBPACK_IMPORTED_MODULE_0__.a3, { options: currentData.calendarOptions, theme: currentData.theme, emitter: currentData.emitter }, (classNames, height, isHeightAuto, forPrint) => {
                        this.setClassNames(classNames);
                        this.setHeight(height);
                        return ((0,preact__WEBPACK_IMPORTED_MODULE_1__.createElement)(_internal_common_js__WEBPACK_IMPORTED_MODULE_0__.a4.Provider, { value: this.customContentRenderId },
...
function buildDateEnv(settings) {
    ...
    return new _internal_common_js__WEBPACK_IMPORTED_MODULE_0__.J(Object.assign(Object.assign({ timeZone: _internal_common_js__WEBPACK_IMPORTED_MODULE_0__.B.timeZone, calendarSystem: 'gregory' }, settings), { locale }));
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "$": function() { return /* binding */ interactionSettingsStore; },
/* harmony export */   "A": function() { return /* binding */ BASE_OPTION_REFINERS; },
...
/* harmony export */   "E": function() { return /* binding */ Emitter; },
/* harmony export */   "F": function() { return /* binding */ CALENDAR_LISTENER_REFINERS; },
/* harmony export */   "G": function() { return /* binding */ CALENDAR_OPTION_REFINERS; },
/* harmony export */   "H": function() { return /* binding */ COMPLEX_OPTION_COMPARATORS; },
/* harmony export */   "I": function() { return /* binding */ VIEW_OPTION_REFINERS; },
/* harmony export */   "J": function() { return /* binding */ DateEnv; },
/* harmony export */   "K": function() { return /* binding */ DateProfileGenerator; },
/* harmony export */   "L": function() { return /* binding */ createEventUi; },
/* harmony export */   "M": function() { return /* binding */ parseBusinessHours; },
/* harmony export */   "N": function() { return /* binding */ BaseComponent; },
/* harmony export */   "O": function() { return /* binding */ setRef; },
/* harmony export */   "P": function() { return /* binding */ Interaction; },
/* harmony export */   "Q": function() { return /* binding */ getElSeg; },
/* harmony export */   "R": function() { return /* binding */ elementClosest; },
/* harmony export */   "S": function() { return /* binding */ EventImpl; },
/* harmony export */   "T": function() { return /* binding */ Theme; },
/* harmony export */   "U": function() { return /* binding */ listenBySelector; },
/* harmony export */   "V": function() { return /* binding */ ViewContextType; },
/* harmony export */   "W": function() { return /* binding */ listenToHoverBySelector; },
/* harmony export */   "X": function() { return /* binding */ PureComponent; },
/* harmony export */   "Y": function() { return /* binding */ buildViewContext; },
/* harmony export */   "Z": function() { return /* binding */ getUniqueDomId; },
/* harmony export */   "_": function() { return /* binding */ parseInteractionSettings; },
/* harmony export */   "a": function() { return /* binding */ mapHash; },
/* harmony export */   "a$": function() { return /* binding */ whenTransitionDone; },
/* harmony export */   "a0": function() { return /* binding */ getNow; },
/* harmony export */   "a1": function() { return /* binding */ CalendarImpl; },
/* harmony export */   "a2": function() { return /* binding */ flushSync; },
/* harmony export */   "a3": function() { return /* binding */ CalendarRoot; },
/* harmony export */   "a4": function() { return /* binding */ RenderId; },
/* harmony export */   "a5": function() { return /* binding */ isArraysEqual; },
/* harmony export */   "a6": function() { return /* binding */ applyStyleProp; },
/* harmony export */   "a7": function() { return /* binding */ sliceEventStore; },
/* harmony export */   "a8": function() { return /* binding */ createPlugin; },
/* harmony export */   "a9": function() { return /* binding */ JsonRequestError; },
/* harmony export */   "aA": function() { return /* binding */ pointInsideRect; },
/* harmony export */   "aB": function() { return /* binding */ constrainPoint; },
/* harmony export */   "aC": function() { return /* binding */ getRectCenter; },
/* harmony export */   "aD": function() { return /* binding */ diffPoints; },
/* harmony export */   "aE": function() { return /* binding */ translateRect; },
/* harmony export */   "aF": function() { return /* binding */ filterHash; },
/* harmony export */   "aG": function() { return /* binding */ compareObjs; },
/* harmony export */   "aH": function() { return /* binding */ collectFromHash; },
/* harmony export */   "aI": function() { return /* binding */ findElements; },
/* harmony export */   "aJ": function() { return /* binding */ findDirectChildren; },
/* harmony export */   "aK": function() { return /* binding */ removeElement; },
/* harmony export */   "aL": function() { return /* binding */ applyStyle; },
/* harmony export */   "aM": function() { return /* binding */ elementMatches; },
/* harmony export */   "aN": function() { return /* binding */ getElRoot; },
/* harmony export */   "aO": function() { return /* binding */ getEventTargetViaRoot; },
/* harmony export */   "aP": function() { return /* binding */ parseClassNames; },
/* harmony export */   "aQ": function() { return /* binding */ getCanVGrowWithinCell; },
/* harmony export */   "aR": function() { return /* binding */ mergeEventStores; },
/* harmony export */   "aS": function() { return /* binding */ getRelevantEvents; },
/* harmony export */   "aT": function() { return /* binding */ eventTupleToStore; },
/* harmony export */   "aU": function() { return /* binding */ combineEventUis; },
/* harmony export */   "aV": function() { return /* binding */ Splitter; },
/* harmony export */   "aW": function() { return /* binding */ getDayClassNames; },
/* harmony export */   "aX": function() { return /* binding */ getDateMeta; },
/* harmony export */   "aY": function() { return /* binding */ getSlotClassNames; },
/* harmony export */   "aZ": function() { return /* binding */ buildNavLinkAttrs; },
/* harmony export */   "a_": function() { return /* binding */ preventDefault; },
/* harmony export */   "aa": function() { return /* binding */ createContext; },
/* harmony export */   "ab": function() { return /* binding */ identity; },
/* harmony export */   "ac": function() { return /* binding */ refineProps; },
/* harmony export */   "ad": function() { return /* binding */ createEventInstance; },
/* harmony export */   "ae": function() { return /* binding */ parseEventDef; },
/* harmony export */   "af": function() { return /* binding */ refineEventDef; },
/* harmony export */   "ag": function() { return /* binding */ padStart; },
/* harmony export */   "ah": function() { return /* binding */ isInt; },
/* harmony export */   "ai": function() { return /* binding */ parseFieldSpecs; },
/* harmony export */   "aj": function() { return /* binding */ compareByFieldSpecs; },
/* harmony export */   "ak": function() { return /* binding */ flexibleCompare; },
/* harmony export */   "al": function() { return /* binding */ preventSelection; },
/* harmony export */   "am": function() { return /* binding */ allowSelection; },
/* harmony export */   "an": function() { return /* binding */ preventContextMenu; },
/* harmony export */   "ao": function() { return /* binding */ allowContextMenu; },
/* harmony export */   "ap": function() { return /* binding */ compareNumbers; },
/* harmony export */   "aq": function() { return /* binding */ enableCursor; },
/* harmony export */   "ar": function() { return /* binding */ disableCursor; },
/* harmony export */   "as": function() { return /* binding */ guid; },
/* harmony export */   "at": function() { return /* binding */ computeVisibleDayRange; },
/* harmony export */   "au": function() { return /* binding */ isMultiDayRange; },
/* harmony export */   "av": function() { return /* binding */ diffDates; },
/* harmony export */   "aw": function() { return /* binding */ removeExact; },
/* harmony export */   "ax": function() { return /* binding */ memoizeArraylike; },
/* harmony export */   "ay": function() { return /* binding */ memoizeHashlike; },
/* harmony export */   "az": function() { return /* binding */ intersectRects; },
/* harmony export */   "b": function() { return /* binding */ buildViewClassNames; },
/* harmony export */   "b$": function() { return /* binding */ requestJson; },
/* harmony export */   "b0": function() { return /* binding */ computeInnerRect; },
/* harmony export */   "b1": function() { return /* binding */ computeEdges; },
/* harmony export */   "b2": function() { return /* binding */ getClippingParents; },
/* harmony export */   "b3": function() { return /* binding */ computeRect; },
/* harmony export */   "b4": function() { return /* binding */ unpromisify; },
/* harmony export */   "b5": function() { return /* binding */ intersectRanges; },
/* harmony export */   "b6": function() { return /* binding */ rangesEqual; },
/* harmony export */   "b7": function() { return /* binding */ rangesIntersect; },
/* harmony export */   "b8": function() { return /* binding */ rangeContainsRange; },
/* harmony export */   "b9": function() { return /* binding */ PositionCache; },
...
/* harmony export */   "ba": function() { return /* binding */ ScrollController; },
/* harmony export */   "bb": function() { return /* binding */ ElementScrollController; },
/* harmony export */   "bc": function() { return /* binding */ WindowScrollController; },
/* harmony export */   "bd": function() { return /* binding */ DateComponent; },
/* harmony export */   "be": function() { return /* binding */ isDateSpansEqual; },
/* harmony export */   "bf": function() { return /* binding */ addDays; },
/* harmony export */   "bg": function() { return /* binding */ startOfDay; },
...
/* harmony export */   "c0": function() { return /* binding */ SimpleScrollGrid; },
/* harmony export */   "c1": function() { return /* binding */ hasShrinkWidth; },
/* harmony export */   "c2": function() { return /* binding */ renderMicroColGroup; },
/* harmony export */   "c3": function() { return /* binding */ getScrollGridClassNames; },
/* harmony export */   "c4": function() { return /* binding */ getSectionClassNames; },
/* harmony export */   "c5": function() { return /* binding */ getSectionHasLiquidHeight; },
/* harmony export */   "c6": function() { return /* binding */ getAllowYScrolling; },
/* harmony export */   "c7": function() { return /* binding */ renderChunkContent; },
/* harmony export */   "c8": function() { return /* binding */ computeShrinkWidth; },
/* harmony export */   "c9": function() { return /* binding */ sanitizeShrinkWidth; },
/* harmony export */   "ca": function() { return /* binding */ isColPropsEqual; },
/* harmony export */   "cb": function() { return /* binding */ renderScrollShim; },
/* harmony export */   "cc": function() { return /* binding */ getStickyFooterScrollbar; },
/* harmony export */   "cd": function() { return /* binding */ getStickyHeaderDates; },
/* harmony export */   "ce": function() { return /* binding */ Scroller; },
/* harmony export */   "cf": function() { return /* binding */ getScrollbarWidths; },
/* harmony export */   "cg": function() { return /* binding */ RefMap; },
/* harmony export */   "ch": function() { return /* binding */ getIsRtlScrollbarOnLeft; },
/* harmony export */   "ci": function() { return /* binding */ NowTimer; },
/* harmony export */   "cj": function() { return /* binding */ ScrollResponder; },
/* harmony export */   "ck": function() { return /* binding */ StandardEvent; },
/* harmony export */   "cl": function() { return /* binding */ NowIndicatorContainer; },
/* harmony export */   "cm": function() { return /* binding */ DayCellContainer; },
/* harmony export */   "cn": function() { return /* binding */ hasCustomDayCellContent; },
/* harmony export */   "co": function() { return /* binding */ EventContainer; },
/* harmony export */   "cp": function() { return /* binding */ renderFill; },
/* harmony export */   "cq": function() { return /* binding */ BgEvent; },
/* harmony export */   "cr": function() { return /* binding */ WeekNumberContainer; },
/* harmony export */   "cs": function() { return /* binding */ MoreLinkContainer; },
/* harmony export */   "ct": function() { return /* binding */ computeEarliestSegStart; },
/* harmony export */   "cu": function() { return /* binding */ ViewContainer; },
/* harmony export */   "cv": function() { return /* binding */ triggerDateSelect; },
/* harmony export */   "cw": function() { return /* binding */ getDefaultEventEnd; },
/* harmony export */   "cx": function() { return /* binding */ buildEventApis; },
/* harmony export */   "cy": function() { return /* binding */ buildElAttrs; },
/* harmony export */   "cz": function() { return /* binding */ CustomRenderingStore; },
/* harmony export */   "d": function() { return /* binding */ createDuration; },
/* harmony export */   "e": function() { return /* binding */ createFormatter; },
/* harmony export */   "f": function() { return /* binding */ formatWithOrdinals; },
/* harmony export */   "g": function() { return /* binding */ globalLocales; },
/* harmony export */   "h": function() { return /* binding */ diffWholeDays; },
/* harmony export */   "i": function() { return /* binding */ injectStyles; },
/* harmony export */   "j": function() { return /* binding */ memoize; },
/* harmony export */   "k": function() { return /* binding */ buildBuildPluginHooks; },
/* harmony export */   "l": function() { return /* binding */ memoizeObjArg; },
/* harmony export */   "m": function() { return /* binding */ mergeProps; },
/* harmony export */   "n": function() { return /* binding */ isPropsEqual; },
/* harmony export */   "o": function() { return /* binding */ getInitialDate; },
/* harmony export */   "p": function() { return /* binding */ initEventSources; },
/* harmony export */   "q": function() { return /* binding */ createEmptyEventStore; },
/* harmony export */   "r": function() { return /* binding */ rangeContainsMarker; },
/* harmony export */   "s": function() { return /* binding */ reduceCurrentDate; },
/* harmony export */   "t": function() { return /* binding */ reduceEventSources; },
/* harmony export */   "u": function() { return /* binding */ reduceEventStore; },
/* harmony export */   "v": function() { return /* binding */ computeEventSourcesLoading; },
/* harmony export */   "w": function() { return /* binding */ reduceEventSourcesNewTimeZone; },
/* harmony export */   "x": function() { return /* binding */ rezoneEventStoreDates; },
/* harmony export */   "y": function() { return /* binding */ mergeRawOptions; },
/* harmony export */   "z": function() { return /* binding */ globalPlugins; }
/* harmony export */ });
/* harmony import */ var preact__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! preact */ "./node_modules/preact/dist/preact.module.js");
...
class TableDateProfileGenerator extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.K {
...
var index = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.a8)({
...
class TableView extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.bd {
    constructor() {
        super(...arguments);
    ...
    renderSimpleLayout(headerRowContent, bodyContent) {
        let { props, context } = this;
        let sections = [];
        let stickyHeaderDates = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cd)(context.options);
        if (headerRowContent) {
            sections.push({
                type: 'header',
                key: 'header',
        ...
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cu, { elClasses: ['fc-daygrid'], viewSpec: context.viewSpec },
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.c0, { liquid: !props.isHeightAuto && !props.forPrint, collapsibleWidth: props.forPrint, cols: [] /* TODO: make optional? */, sections: sections })));
    }
    renderHScrollLayout(headerRowContent, bodyContent, colCnt, dayMinWidth) {
        ...
        let { props, context } = this;
        let stickyHeaderDates = !props.forPrint && (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cd)(context.options);
        let stickyFooterScrollbar = !props.forPrint && (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cc)(context.options);
        let sections = [];
        if (headerRowContent) {
            sections.push({
                type: 'header',
        ...
        if (stickyFooterScrollbar) {
            sections.push({
                ...
                chunks: [{
                        key: 'main',
                        content: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cb,
                    }],
            });
        }
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cu, { elClasses: ['fc-daygrid'], viewSpec: context.viewSpec },
...
const DEFAULT_TABLE_EVENT_TIME_FORMAT = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.e)({
    hour: 'numeric',
    minute: '2-digit',
    omitZeroMinute: true,
    meridiem: 'narrow',
...
class TableBlockEvent extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.N {
    render() {
        let { props } = this;
...
class TableListItemEvent extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.N {
    render() {
        let { props, context } = this;
        let { options } = context;
        let { seg } = props;
...
class TableCellMoreLink extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.N {
    constructor() {
        super(...arguments);
        this.compileSegs = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.j)(compileSegs);
    }
    render() {
        let { props } = this;
...
const DEFAULT_WEEK_NUM_FORMAT = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.e)({ week: 'narrow' });
class TableCell extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.bd {
    constructor() {
        super(...arguments);
        this.rootElRef = (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__.createRef)();
        this.state = {
            dayNumberId: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.Z)(),
        };
        this.handleRootEl = (el) => {
            (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.O)(this.rootElRef, el);
            (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.O)(this.props.elRef, el);
        };
    }
    render() {
        ...
        let { options } = context;
        let { date, dateProfile } = props;
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cm, { elTag: "td", elRef: this.handleRootEl, elClasses: [
                'fc-daygrid-day',
                ...(props.extraClassNames || []),
            ...
            props.showWeekNumber && ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cr, { elTag: "a", elClasses: ['fc-daygrid-week-number'], elAttrs: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aZ)(context, date, 'week'), date: date, defaultFormat: DEFAULT_WEEK_NUM_FORMAT })),
            Boolean(!renderProps.isDisabled &&
                (props.showDayNumber || (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cn)(options) || props.forceDayTop)) && ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", { className: "fc-daygrid-day-top" },
                (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__.createElement)(InnerContent, { elTag: "a", elClasses: ['fc-daygrid-day-number'], elAttrs: Object.assign(Object.assign({}, (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aZ)(context, date)), { id: state.dayNumberId }) }))),
...
function resliceSeg(seg, spanStart, spanEnd, cells) {
    ...
    let slicedRange = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.b5)(origRange, {
        start: cells[spanStart].date,
        end: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.bf)(cells[spanEnd - 1].date, 1),
    });
...
class TableRow extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.bd {
    constructor() {
        super(...arguments);
        this.cellElRefs = new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cg(); // the <td>
        this.frameElRefs = new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cg(); // the fc-daygrid-day-frame
        this.fgElRefs = new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cg(); // the fc-daygrid-day-events
        this.segHarnessRefs = new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cg(); // indexed by "instanceId:firstCol"
        this.rootElRef = (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__.createRef)();
        this.state = {
            framePositions: null,
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        this.updateSizing(!(0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.n)(prevProps, currentProps));
    }
    componentWillUnmount() {
        this.context.removeResizeHandler(this.handleResize);
    }
        ...
        if (framePositions) {
            for (let seg of segs) {
                ...
                nodes.push((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", { key: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.bT)(seg.eventRange), className: "fc-daygrid-bg-harness", style: leftRightCss }, fillType === 'bg-event' ?
                    (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cq, Object.assign({ seg: seg }, (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.bS)(seg, todayRange))) :
                    (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cp)(fillType)));
            }
        }
        ...
        if (!props.forPrint &&
            ...
            if (isExternalSizingChange) {
                ...
                if (frameEls.length) {
                    ...
                    this.setState({
                        framePositions: new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.b9(originEl, frameEls, true, // isHorizontal
                        false),
                    });
                }
            }
...
TableRow.addStateEquality({
    eventInstanceHeights: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.n,
});
...
class Table extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.bd {
    constructor() {
        super(...arguments);
        this.splitBusinessHourSegs = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.j)(splitSegsByRow);
        this.splitBgEventSegs = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.j)(splitSegsByRow);
        this.splitFgEventSegs = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.j)(splitSegsByRow);
        this.splitDateSelectionSegs = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.j)(splitSegsByRow);
        this.splitEventDrag = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.j)(splitInteractionByRow);
        this.splitEventResize = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.j)(splitInteractionByRow);
        this.rowRefs = new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cg();
        this.handleRootEl = (rootEl) => {
            this.rootEl = rootEl;
            if (rootEl) {
                this.context.registerInteractiveComponent(this, {
    ...
    // ----------------------------------------------------------------------------------------------------
    prepareHits() {
        this.rowPositions = new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.b9(this.rootEl, this.rowRefs.collect().map((rowObj) => rowObj.getCellEls()[0]), // first cell el in each row. TODO: not optimal
        false, true);
        this.colPositions = new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.b9(this.rootEl, this.rowRefs.currentMap[0].getCellEls(), // cell els in first row
        true, // horizontal
        false);
    }
    ...
    getCellRange(row, col) {
        ...
        let end = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.bf)(start, 1);
        return { start, end };
    }
}
...
class DayTable extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.bd {
    constructor() {
        super(...arguments);
...
class DayTableView extends TableView {
    constructor() {
        super(...arguments);
        this.buildDayTableModel = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.j)(buildDayTableModel);
...
class PointerDragging {
    ...
    tryStart(ev) {
        ...
        if (subjectEl &&
            (!this.handleSelector || (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.R)(downEl, this.handleSelector))) {
    ...
    querySubjectEl(ev) {
        if (this.selector) {
            return (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.R)(ev.target, this.selector);
        }
...
class ElementMirror {
    ...
    doRevertAnimation(callback, revertDuration) {
        ...
        (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aL)(mirrorEl, {
            left: finalSourceElRect.left,
            top: finalSourceElRect.top,
        });
        (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.a$)(mirrorEl, () => {
            mirrorEl.style.transition = '';
            callback();
        });
    }
    cleanup() {
        if (this.mirrorEl) {
            (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aK)(this.mirrorEl);
            this.mirrorEl = null;
        }
        this.sourceEl = null;
    }
    updateElPosition() {
        if (this.sourceEl && this.isVisible) {
            (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aL)(this.getMirrorEl(), {
...
*/
class ScrollGeomCache extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ba {
...
class ElementScrollGeomCache extends ScrollGeomCache {
    constructor(el, doesListening) {
        super(new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.bb(el), doesListening);
    }
    getEventTarget() {
        return this.scrollController.el;
    }
    computeClientRect() {
        return (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.b0)(this.scrollController.el);
    }
}

class WindowScrollGeomCache extends ScrollGeomCache {
    constructor(doesListening) {
        super(new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.bc(), doesListening);
    }
    getEventTarget() {
        return window;
    }
    ...
    queryScrollEls(scrollStartEl) {
        ...
        for (let query of this.scrollQuery) {
            if (typeof query === 'object') {
                ...
                els.push(...Array.prototype.slice.call((0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aN)(scrollStartEl).querySelectorAll(query)));
            }
        }
        return els;
    }
    ...
    constructor(containerEl, selector) {
        ...
        this.onPointerDown = (ev) => {
            if (!this.isDragging) { // so new drag doesn't happen while revert animation is going
                ...
                this.isDelayEnded = false;
                this.isDistanceSurpassed = false;
                (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.al)(document.body);
                (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.an)(document.body);
        ...
        this.onPointerUp = (ev) => {
            if (this.isInteracting) {
                ...
                (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.am)(document.body);
                (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ao)(document.body);
...
class OffsetTracker {
    constructor(el) {
        this.origRect = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.b3)(el);
        // will work fine for divs that have overflow:hidden
        this.scrollCaches = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.b2)(el).map((scrollEl) => new ElementScrollGeomCache(scrollEl, true));
    }
    destroy() {
        for (let scrollCache of this.scrollCaches) {
            scrollCache.destroy();
    ...
    isWithinClipping(pageX, pageY) {
        ...
        for (let scrollCache of this.scrollCaches) {
            if (!isIgnoredClipping(scrollCache.getEventTarget()) &&
                !(0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aA)(point, scrollCache.clientRect)) {
                return false;
            }
        }
        return true;
...
class HitDragging {
    ...
    processFirstCoord(ev) {
        ...
        if (subjectEl instanceof HTMLElement) { // i.e. not a Document/ShadowRoot
            subjectRect = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.b3)(subjectEl);
            adjustedPoint = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aB)(adjustedPoint, subjectRect);
        }
        let initialHit = this.initialHit = this.queryHitForOffset(adjustedPoint.left, adjustedPoint.top);
        if (initialHit) {
            if (this.useSubjectCenter && subjectRect) {
                let slicedSubjectRect = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.az)(subjectRect, initialHit.rect);
                if (slicedSubjectRect) {
                    adjustedPoint = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aC)(slicedSubjectRect);
                }
            }
            this.coordAdjust = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aD)(adjustedPoint, origPoint);
        }
        else {
        ...
        for (let id in droppableStore) {
            ...
            if (offsetTracker && // wasn't destroyed mid-drag
                ...
                positionLeft >= 0 && positionLeft < width &&
                    ...
                    (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.b8)(hit.dateProfile.activeRange, hit.dateSpan.range)) &&
...
function isHitsEqual(hit0, hit1) {
    ...
    return (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.be)(hit0.dateSpan, hit1.dateSpan);
}
...
*/
class DateClicking extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.P {
    constructor(settings) {
        super(settings);
...
*/
class DateSelecting extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.P {
    constructor(settings) {
        super(settings);
        ...
        this.handleHitUpdate = (hit, isFinal) => {
            ...
            if (!isInvalid) {
                (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aq)();
            }
            else {
                (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ar)();
            }
            if (!isFinal) {
        ...
        this.handlePointerUp = (pev) => {
            if (this.dragSelection) {
                ...
                (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cv)(this.dragSelection, pev, this.component.context);
                this.dragSelection = null;
            }
        };
...
function joinHitsIntoSelection(hit0, hit1, dateSelectionTransformers) {
    ...
    ms.sort(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ap);
    let props = {};
...
class EventDragging extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.P {
    constructor(settings) {
        super(settings);
        // internal state
        this.subjectEl = null;
        ...
        this.handlePointerDown = (ev) => {
            ...
            let subjectSeg = this.subjectSeg = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.Q)(ev.subjectEl);
            let eventRange = this.eventRange = subjectSeg.eventRange;
            let eventInstanceId = eventRange.instance.instanceId;
            this.relevantEvents = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aS)(initialContext.getCurrentData().eventStore, eventInstanceId);
            ...
            if (options.fixedMirrorParent) {
                ...
                mirror.parentNode = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.R)(origTarget, '.fc');
            }
            mirror.revertDuration = options.dragRevertDuration;
            let isValid = component.isValidSegDownEl(origTarget) &&
                !(0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.R)(origTarget, '.fc-event-resizer'); // NOT on a resizer
        ...
        this.handleDragStart = (ev) => {
            ...
            if (this.isDragging) {
                ...
                initialContext.emitter.trigger('eventDragStart', {
                    el: this.subjectEl,
                    event: new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.S(initialContext, eventRange.def, eventRange.instance),
        ...
        this.handleHitUpdate = (hit, isFinal) => {
            ...
            let interaction = {
                ...
                mutatedEvents: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.q)(),
                isEvent: true,
            };
            if (hit) {
                ...
                if (initialContext === receivingContext ||
                    ...
                    if (mutation) {
                        ...
                        if (!(0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.bZ)(interaction, hit.dateProfile, receivingContext)) {
                            ...
                            interaction.mutatedEvents = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.q)();
                        }
                    }
                }
                else {
            ...
            if (!isFinal) {
                ...
                this.dragging.setMirrorIsVisible(!hit || !(0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aN)(this.subjectEl).querySelector('.fc-event-mirror'));
        ...
        this.handleDragEnd = (ev) => {
            if (this.isDragging) {
                ...
                let eventApi = new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.S(initialContext, eventDef, eventInstance);
                let relevantEvents = this.relevantEvents;
                ...
                if (validMutation) {
                    ...
                    if (receivingContext === initialContext) {
                        let updatedEventApi = new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.S(initialContext, mutatedRelevantEvents.defs[eventDef.defId], eventInstance ? mutatedRelevantEvents.instances[eventInstance.instanceId] : null);
                        ...
                        let eventChangeArg = {
                            ...
                            relatedEvents: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cx)(mutatedRelevantEvents, initialContext, eventInstance),
                            revert() {
                                initialContext.dispatch({
                                    type: 'MERGE_EVENTS',
                        ...
                        let eventRemoveArg = {
                            event: eventApi,
                            relatedEvents: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cx)(relevantEvents, initialContext, eventInstance),
                            revert() {
                                initialContext.dispatch({
                                    type: 'MERGE_EVENTS',
                                    eventStore: relevantEvents,
                        ...
                        let addedEventApi = new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.S(receivingContext, addedEventDef, addedEventInstance);
                        ...
                        let eventAddArg = {
                            event: addedEventApi,
                            relatedEvents: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cx)(mutatedRelevantEvents, receivingContext, addedEventInstance),
                            revert() {
                                receivingContext.dispatch({
                                    type: 'REMOVE_EVENTS',
                                    eventStore: mutatedRelevantEvents,
        ...
        dragging.touchScrollAllowed = false;
        dragging.autoScroller.isEnabled = options.dragScroll;
        let hitDragging = this.hitDragging = new HitDragging(this.dragging, _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.$);
...
function computeEventMutation(hit0, hit1, massagers) {
    ...
    if (dateSpan0.allDay !== dateSpan1.allDay) {
        ...
        if (dateSpan1.allDay) {
            ...
            date0 = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.bg)(date0);
        }
    }
    let delta = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.av)(date0, date1, hit0.context.dateEnv, hit0.componentId === hit1.componentId ?
        hit0.largeUnit :
        null);
...
class EventResizing extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.P {
    constructor(settings) {
        super(settings);
        // internal state
        ...
        this.handlePointerDown = (ev) => {
            ...
            let seg = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.Q)(segEl);
        ...
        this.handleDragStart = (ev) => {
            let { context } = this.component;
            let eventRange = this.eventRange;
            this.relevantEvents = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aS)(context.getCurrentData().eventStore, this.eventRange.instance.instanceId);
            let segEl = this.querySegEl(ev);
            this.draggingSegEl = segEl;
            this.draggingSeg = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.Q)(segEl);
            context.calendarApi.unselect();
            context.emitter.trigger('eventResizeStart', {
                el: segEl,
                event: new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.S(context, eventRange.def, eventRange.instance),
                jsEvent: ev.origEvent,
                view: context.viewApi,
            });
        };
        ...
        this.handleDragEnd = (ev) => {
            ...
            let eventDef = this.eventRange.def;
            let eventInstance = this.eventRange.instance;
            let eventApi = new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.S(context, eventDef, eventInstance);
            let relevantEvents = this.relevantEvents;
            let mutatedRelevantEvents = this.mutatedRelevantEvents;
            ...
            if (this.validMutation) {
                let updatedEventApi = new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.S(context, mutatedRelevantEvents.defs[eventDef.defId], eventInstance ? mutatedRelevantEvents.instances[eventInstance.instanceId] : null);
                context.dispatch({
                    type: 'MERGE_EVENTS',
                    eventStore: mutatedRelevantEvents,
                });
                let eventChangeArg = {
                    oldEvent: eventApi,
                    event: updatedEventApi,
                    relatedEvents: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cx)(mutatedRelevantEvents, context, eventInstance),
                    revert() {
                        context.dispatch({
                            type: 'MERGE_EVENTS',
    ...
    querySegEl(ev) {
        return (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.R)(ev.subjectEl, '.fc-event');
    }
}
function computeMutation(hit0, hit1, isFromStart, instanceRange) {
    ...
    let delta = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.av)(date0, date1, dateEnv, hit0.largeUnit);
    if (isFromStart) {
...
class UnselectAuto {
    constructor(context) {
        ...
        this.onDocumentPointerDown = (pev) => {
            ...
            let downEl = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aO)(pev.origEvent);
            this.matchesCancel = !!(0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.R)(downEl, unselectCancel);
            this.matchesEvent = !!(0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.R)(downEl, EventDragging.SELECTOR); // interaction started on an event?
        };
...
const OPTION_REFINERS = {
    fixedMirrorParent: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ab,
};
const LISTENER_REFINERS = {
    dateClick: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ab,
    eventDragStart: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ab,
    eventDragStop: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ab,
    eventDrop: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ab,
    eventResizeStart: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ab,
    eventResizeStop: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ab,
    eventResize: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ab,
    drop: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ab,
    eventReceive: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ab,
    eventLeave: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ab,
};
...
class ExternalElementDragging {
    constructor(dragging, suppliedDragMeta) {
        ...
        this.handleHitUpdate = (hit, isFinal, ev) => {
            ...
            let isInvalid = false;
            let interaction = {
                affectedEvents: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.q)(),
                mutatedEvents: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.q)(),
            ...
            if (hit) {
                ...
                if (this.canDropElOnCalendar(ev.subjectEl, receivingContext)) {
                    ...
                    interaction.mutatedEvents = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aT)(droppableEvent);
        ...
        this.handleDragEnd = (pev) => {
            ...
            if (receivingContext && droppableEvent) {
                ...
                if (dragMeta.create) {
                    let addingEvents = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aT)(droppableEvent);
                    receivingContext.dispatch({
                        type: 'MERGE_EVENTS',
                    ...
                    receivingContext.emitter.trigger('eventReceive', {
                        event: new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.S(receivingContext, droppableEvent.def, droppableEvent.instance),
                        relatedEvents: [],
                        revert() {
                            receivingContext.dispatch({
                                type: 'REMOVE_EVENTS',
        ...
        let hitDragging = this.hitDragging = new HitDragging(dragging, _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.$);
    ...
    canDropElOnCalendar(el, receivingContext) {
        ...
        if (typeof dropAccept === 'string' && dropAccept) {
            return Boolean((0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aM)(el, dropAccept));
        }
        return true;
    }
}
...
function computeEventForDateSpan(dateSpan, dragMeta, context) {
    ...
    let { refined, extra } = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.af)(defProps, context);
    let def = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ae)(refined, extra, dragMeta.sourceId, dateSpan.allDay, context.options.forceEventDuration || Boolean(dragMeta.duration), // hasEnd
    context);
    ...
    let end = dragMeta.duration ?
        ...
        (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cw)(dateSpan.allDay, start, context);
    let instance = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ad)(def.defId, { start, end });
    return { def, instance };
}
...
const OPTION_REFINERS = {
    ...
    noEventsClassNames: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ab,
    noEventsContent: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ab,
    noEventsDidMount: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ab,
    noEventsWillUnmount: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ab,
    // noEventsText is defined in base options
};
function createFalsableFormatter(input) {
    return input === false ? null : (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.e)(input);
}
...
class ListViewHeaderRow extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.N {
    constructor() {
        super(...arguments);
        this.state = {
            textId: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.Z)(),
        };
    }
    render() {
        ...
        let dayMeta = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aX)(dayDate, todayRange);
        // will ever be falsy?
        ...
        let renderProps = Object.assign({ date: dateEnv.toDate(dayDate), view: viewApi, textId,
            text,
            sideText, navLinkAttrs: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aZ)(this.context, dayDate), sideNavLinkAttrs: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aZ)(this.context, dayDate, 'day', false) }, dayMeta);
        ...
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.C, { elTag: "tr", elClasses: [
                'fc-list-day',
                ...(0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.aW)(dayMeta, theme),
            ], elAttrs: {
                'data-date': (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.bw)(dayDate),
...
const DEFAULT_TIME_FORMAT = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.e)({
    hour: 'numeric',
    minute: '2-digit',
    meridiem: 'short',
});
class ListViewEventRow extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.N {
    render() {
        let { props, context } = this;
        let { options } = context;
        let { seg, timeHeaderId, eventHeaderId, dateHeaderId } = props;
        let timeFormat = options.eventTimeFormat || DEFAULT_TIME_FORMAT;
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.co, Object.assign({}, props, { elTag: "tr", elClasses: [
                'fc-list-event',
...
function buildTimeContent(seg, timeFormat, context, timeHeaderId, dateHeaderId) {
    ...
    if (options.displayEventTime !== false) {
        ...
        else if ((0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.au)(seg.eventRange.range)) { // TODO: use (!isStart || !isEnd) instead?
            if (seg.isStart) {
...
*/
class ListView extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.bd {
    constructor() {
        super(...arguments);
        this.computeDateVars = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.j)(computeDateVars);
        this.eventStoreToSegs = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.j)(this._eventStoreToSegs);
        this.state = {
            timeHeaderId: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.Z)(),
            eventHeaderId: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.Z)(),
            dateHeaderIdRoot: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.Z)(),
        };
    ...
    render() {
        ...
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.cu, { elRef: this.setRootEl, elClasses: [
                'fc-list',
                context.theme.getClass('table'),
            ...
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ce, { liquid: !props.isHeightAuto, overflowX: props.isHeightAuto ? 'visible' : 'hidden', overflowY: props.isHeightAuto ? 'visible' : 'auto' }, eventSegs.length > 0 ?
    ...
    renderEmptyMessage() {
        ...
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.C, { elTag: "div", elClasses: ['fc-list-empty'], renderProps: renderProps, generatorName: "noEventsContent", generator: options.noEventsContent || renderNoEventsInner, classNameGenerator: options.noEventsClassNames, didMount: options.noEventsDidMount, willUnmount: options.noEventsWillUnmount }, (InnerContent) => ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__.createElement)(InnerContent, { elTag: "div", elClasses: ['fc-list-empty-cushion'] }))));
    }
    renderSegList(allSegs, dayDates) {
        let { theme, options } = this.context;
        let { timeHeaderId, eventHeaderId, dateHeaderIdRoot } = this.state;
        let segsByDay = groupSegsByDay(allSegs); // sparse array
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_1__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.ci, { unit: "day" }, (nowDate, todayRange) => {
            let innerNodes = [];
            for (let dayIndex = 0; dayIndex < segsByDay.length; dayIndex += 1) {
                let daySegs = segsByDay[dayIndex];
                if (daySegs) { // sparse array, so might be undefined
                    let dayStr = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.bw)(dayDates[dayIndex]);
    ...
    _eventStoreToSegs(eventStore, eventUiBases, dayRanges) {
        return this.eventRangesToSegs((0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.a7)(eventStore, eventUiBases, this.props.dateProfile.activeRange, this.context.options.nextDayThreshold).fg, dayRanges);
    }
    ...
    eventRangeToSegs(eventRange, dayRanges) {
        ...
        for (dayIndex = 0; dayIndex < dayRanges.length; dayIndex += 1) {
            segRange = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.b5)(range, dayRanges[dayIndex]);
            if (segRange) {
                seg = {
                    component: this,
                    eventRange,
...
function computeDateVars(dateProfile) {
    let dayStart = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.bg)(dateProfile.renderRange.start);
    ...
    while (dayStart < viewEnd) {
        ...
        dayRanges.push({
            start: dayStart,
            end: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.bf)(dayStart, 1),
        });
        dayStart = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_0__.bf)(dayStart, 1);
    }
...
Object(function webpackMissingModule() { var e = new Error("Cannot find module '@fullcalendar/daygrid/internal.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
(0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.i)(css_248z);

var index = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.a8)({
...
/* harmony export */ });
/* harmony import */ var _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @fullcalendar/core/internal.js */ "./node_modules/@fullcalendar/core/internal-common.js");
/* harmony import */ var _fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @fullcalendar/core/preact.js */ "./node_modules/preact/dist/preact.module.js");
Object(function webpackMissingModule() { var e = new Error("Cannot find module '@fullcalendar/daygrid/internal.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());




class AllDaySplitter extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.aV {
    getKeyInfo() {
        return {
            allDay: {},
            timed: {},
    ...
    getKeysForEventDef(eventDef) {
        ...
        if ((0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bP)(eventDef)) {
            return ['timed', 'allDay'];
        }
        return ['allDay'];
    }
...
const DEFAULT_SLAT_LABEL_FORMAT = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.e)({
    hour: 'numeric',
    minute: '2-digit',
    omitZeroMinute: true,
    meridiem: 'short',
...
function TimeColsAxisCell(props) {
    ...
    return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.V.Consumer, null, (context) => {
        if (!props.isLabeled) {
            return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("td", { className: classNames.join(' '), "data-time": props.isoTimeStr }));
        }
        let { dateEnv, options, viewApi } = context;
        let labelFormat = // TODO: fully pre-parse
         options.slotLabelFormat == null ? DEFAULT_SLAT_LABEL_FORMAT :
            Array.isArray(options.slotLabelFormat) ? (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.e)(options.slotLabelFormat[0]) :
                (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.e)(options.slotLabelFormat);
        let renderProps = {
            level: 0,
            time: props.time,
        ...
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.C, { elTag: "td", elClasses: classNames, elAttrs: {
                'data-time': props.isoTimeStr,
            }, renderProps: renderProps, generatorName: "slotLabelContent", generator: options.slotLabelContent || renderInnerContent, classNameGenerator: options.slotLabelClassNames, didMount: options.slotLabelDidMount, willUnmount: options.slotLabelWillUnmount }, (InnerContent) => ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: "fc-timegrid-slot-label-frame fc-scrollgrid-shrink-frame" },
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(InnerContent, { elTag: "div", elClasses: [
...
class TimeBodyAxis extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.N {
    render() {
        return this.props.slatMetas.map((slatMeta) => ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("tr", { key: slatMeta.key },
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(TimeColsAxisCell, Object.assign({}, slatMeta)))));
    }
}

const DEFAULT_WEEK_NUM_FORMAT = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.e)({ week: 'short' });
const AUTO_ALL_DAY_MAX_EVENT_ROWS = 5;
class TimeColsView extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bd {
    constructor() {
        super(...arguments);
        this.allDaySplitter = new AllDaySplitter(); // for use by subclasses
        this.headerElRef = (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createRef)();
        this.rootElRef = (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createRef)();
        this.scrollerElRef = (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createRef)();
        this.state = {
            slatCoords: null,
        };
        ...
        this.renderHeadAxis = (rowKey, frameHeight = '') => {
            ...
            let dayCnt = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bm)(range.start, range.end);
            // only do in day views (to avoid doing in week views that dont need it)
            let navLinkAttrs = (dayCnt === 1)
                ? (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.aZ)(this.context, range.start, 'week')
                : {};
            if (options.weekNumbers && rowKey === 'day') {
                return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cr, { elTag: "th", elClasses: [
                        'fc-timegrid-axis',
                        'fc-scrollgrid-shrink',
                    ], elAttrs: {
                        'aria-hidden': true,
                    }, date: range.start, defaultFormat: DEFAULT_WEEK_NUM_FORMAT }, (InnerContent) => ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: [
                        'fc-timegrid-axis-frame',
                        'fc-scrollgrid-shrink-frame',
                        'fc-timegrid-axis-frame-liquid',
                    ].join(' '), style: { height: frameHeight } },
                    (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(InnerContent, { elTag: "a", elClasses: [
                            'fc-timegrid-axis-cushion',
                            'fc-scrollgrid-shrink-cushion',
                            'fc-scrollgrid-sync-inner',
                        ], elAttrs: navLinkAttrs })))));
            }
            return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("th", { "aria-hidden": true, className: "fc-timegrid-axis" },
                (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: "fc-timegrid-axis-frame", style: { height: frameHeight } })));
        };
        ...
        this.renderTableRowAxis = (rowHeight) => {
            ...
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.C, { elTag: "td", elClasses: [
                    'fc-timegrid-axis',
                    'fc-scrollgrid-shrink',
                ], elAttrs: {
                    'aria-hidden': true,
                }, renderProps: renderProps, generatorName: "allDayContent", generator: options.allDayContent || renderAllDayInner, classNameGenerator: options.allDayClassNames, didMount: options.allDayDidMount, willUnmount: options.allDayWillUnmount }, (InnerContent) => ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: [
                    'fc-timegrid-axis-frame',
                    'fc-scrollgrid-shrink-frame',
                    rowHeight == null ? ' fc-timegrid-axis-frame-liquid' : '',
                ].join(' '), style: { height: rowHeight } },
                (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(InnerContent, { elTag: "span", elClasses: [
                        'fc-timegrid-axis-cushion',
                        'fc-scrollgrid-shrink-cushion',
                        'fc-scrollgrid-sync-inner',
                    ] })))));
    ...
    renderSimpleLayout(headerRowContent, allDayContent, timeContent) {
        ...
        let sections = [];
        let stickyHeaderDates = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cd)(context.options);
        if (headerRowContent) {
            sections.push({
                type: 'header',
                key: 'header',
        ...
        if (allDayContent) {
            ...
            sections.push({
                ...
                (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("tr", { role: "presentation", className: "fc-scrollgrid-section" },
                    (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("td", { className: 'fc-timegrid-divider ' + context.theme.getClass('tableCellShaded') }))),
            });
        }
        sections.push({
            type: 'body',
        ...
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cu, { elRef: this.rootElRef, elClasses: ['fc-timegrid'], viewSpec: context.viewSpec },
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.c0, { liquid: !props.isHeightAuto && !props.forPrint, collapsibleWidth: props.forPrint, cols: [{ width: 'shrink' }], sections: sections })));
    }
    renderHScrollLayout(headerRowContent, allDayContent, timeContent, colCnt, dayMinWidth, slatMetas, slatCoords) {
        ...
        let { context, props } = this;
        let stickyHeaderDates = !props.forPrint && (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cd)(context.options);
        let stickyFooterScrollbar = !props.forPrint && (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cc)(context.options);
        let sections = [];
        if (headerRowContent) {
            sections.push({
                type: 'header',
                ...
                chunks: [
                    {
                        key: 'axis',
                        rowContent: (arg) => ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("tr", { role: "presentation" }, this.renderHeadAxis('day', arg.rowSyncHeights[0]))),
                    },
                    {
                        key: 'cols',
                        elRef: this.headerElRef,
        ...
        if (allDayContent) {
            sections.push({
                ...
                chunks: [
                    {
                        key: 'axis',
                        rowContent: (contentArg) => ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("tr", { role: "presentation" }, this.renderTableRowAxis(contentArg.rowSyncHeights[0]))),
                    },
                    {
                        key: 'cols',
            ...
            sections.push({
                ...
                outerContent: ( // TODO: rename to cellContent so don't need to define <tr>?
                (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("tr", { role: "presentation", className: "fc-scrollgrid-section" },
                    (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("td", { colSpan: 2, className: 'fc-timegrid-divider ' + context.theme.getClass('tableCellShaded') }))),
            });
        }
            ...
            chunks: [
                {
                    ...
                    (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: "fc-timegrid-axis-chunk" },
                        (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("table", { "aria-hidden": true, style: { height: arg.expandRows ? arg.clientHeight : '' } },
                            arg.tableColGroupNode,
                            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("tbody", null,
                                (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(TimeBodyAxis, { slatMetas: slatMetas }))),
                        (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: "fc-timegrid-now-indicator-container" },
                            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.ci, { unit: isNowIndicator ? 'minute' : 'day' /* hacky */ }, (nowDate) => {
                                let nowIndicatorTop = isNowIndicator &&
                                    slatCoords &&
                                    slatCoords.safeComputeTop(nowDate); // might return void
                                if (typeof nowIndicatorTop === 'number') {
                                    return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cl, { elClasses: ['fc-timegrid-now-indicator-arrow'], elStyle: { top: nowIndicatorTop }, isAxis: true, date: nowDate }));
                                }
                                return null;
                            })))),
                },
        ...
        if (stickyFooterScrollbar) {
            sections.push({
                ...
                chunks: [
                    {
                        key: 'axis',
                        content: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cb,
                    },
                    {
                        key: 'cols',
                        content: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cb,
        ...
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cu, { elRef: this.rootElRef, elClasses: ['fc-timegrid'], viewSpec: context.viewSpec },
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(ScrollGrid, { liquid: !props.isHeightAuto && !props.forPrint, collapsibleWidth: false, colGroups: [
...
class TimeColsSlatsCoords {
    ...
    safeComputeTop(date) {
        ...
        if ((0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.r)(dateProfile.currentRange, date)) {
            let startOfDayDate = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bg)(date);
            let timeMs = date.valueOf() - startOfDayDate.valueOf();
            if (timeMs >= (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bt)(dateProfile.slotMinTime) &&
                timeMs < (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bt)(dateProfile.slotMaxTime)) {
                return this.computeTimeTop((0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.d)(timeMs));
            }
        }
        return null;
    }
    ...
    computeDateTop(when, startOfDayDate) {
        if (!startOfDayDate) {
            startOfDayDate = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bg)(when);
        }
        return this.computeTimeTop((0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.d)(when.valueOf() - startOfDayDate.valueOf()));
    }
    ...
    computeTimeTop(duration) {
        ...
        let slatCoverage = (duration.milliseconds - (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bt)(dateProfile.slotMinTime)) / (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bt)(this.slotDuration);
        let slatIndex;
        let slatRemainder;
...
class TimeColsSlatsBody extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.N {
    render() {
        let { props, context } = this;
        let { options } = context;
        let { slatElRefs } = props;
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("tbody", null, props.slatMetas.map((slatMeta, i) => {
            let renderProps = {
                time: slatMeta.time,
                date: context.dateEnv.toDate(slatMeta.date),
                view: context.viewApi,
            };
            return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("tr", { key: slatMeta.key, ref: slatElRefs.createRef(slatMeta.key) },
                props.axis && ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(TimeColsAxisCell, Object.assign({}, slatMeta))),
                (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.C, { elTag: "td", elClasses: [
                        'fc-timegrid-slot',
...
*/
class TimeColsSlats extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.N {
    constructor() {
        super(...arguments);
        this.rootElRef = (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createRef)();
        this.slatElRefs = new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cg();
    }
    render() {
        let { props, context } = this;
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { ref: this.rootElRef, className: "fc-timegrid-slots" },
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("table", { "aria-hidden": true, className: context.theme.getClass('table'), style: {
                    minWidth: props.tableMinWidth,
                    width: props.clientWidth,
                    height: props.minHeight,
                } },
                props.tableColGroupNode /* relies on there only being a single <col> for the axis */,
                (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(TimeColsSlatsBody, { slatElRefs: this.slatElRefs, axis: props.axis, slatMetas: props.slatMetas }))));
    }
    componentDidMount() {
        this.updateSizing();
    }
    ...
    updateSizing() {
        ...
        if (props.onCoords &&
            ...
            if (rootEl.offsetHeight) { // not hidden by css
                props.onCoords(new TimeColsSlatsCoords(new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.b9(this.rootElRef.current, collectSlatEls(this.slatElRefs.currentMap, props.slatMetas), false, true), this.props.dateProfile, context.options.slotDuration));
            }
        }
    }
}
...
class TimeColMoreLink extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.N {
    render() {
        let { props } = this;
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cs, { elClasses: ['fc-timegrid-more-link'], elStyle: {
                top: props.top,
                bottom: props.bottom,
            }, allDayDate: null, moreCnt: props.hiddenSegs.length, allSegs: props.hiddenSegs, hiddenSegs: props.hiddenSegs, extraDateSpan: props.extraDateSpan, dateProfile: props.dateProfile, todayRange: props.todayRange, popoverContent: () => renderPlainFgSegs(props.hiddenSegs, props), defaultGenerator: renderMoreLinkInner }, (InnerContent) => ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(InnerContent, { elTag: "div", elClasses: ['fc-timegrid-more-link-inner', 'fc-sticky'] }))));
    }
}
function renderMoreLinkInner(props) {
...
function buildPositioning(segInputs, strictOrder, maxStackCnt) {
    let hierarchy = new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bA();
    if (strictOrder != null) {
        hierarchy.strictOrder = strictOrder;
    }
    if (maxStackCnt != null) {
    ...
    let hiddenEntries = hierarchy.addSegs(segInputs);
    let hiddenGroups = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bE)(hiddenEntries);
...
function findNextLevelSegs(hierarchy, subjectLevel, subjectLateral) {
    ...
    for (; level < levelCnt; level += 1) {
        let entries = entriesByLevel[level];
        let entry;
        let searchIndex = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bD)(entries, subjectEntry.span.start, _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bC);
...
function stretchWeb(topLevelNodes, totalThickness) {
    const stretchNode = cacheable((node, startCoord, prevThickness) => (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bB)(node), (node, startCoord, prevThickness) => {
...
function webToRects(topLevelNodes) {
    let rects = [];
    const processNode = cacheable((node, levelCoord, stackDepth) => (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bB)(node), (node, levelCoord, stackDepth) => {
...
const DEFAULT_TIME_FORMAT = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.e)({
    hour: 'numeric',
    minute: '2-digit',
    meridiem: false,
});
class TimeColEvent extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.N {
    render() {
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.ck, Object.assign({}, this.props, { elClasses: [
                'fc-timegrid-event',
                'fc-v-event',
...
class TimeCol extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.N {
    constructor() {
        super(...arguments);
        this.sortEventSegs = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.j)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bR);
    }
    ...
    render() {
        ...
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cm, { elTag: "td", elRef: props.elRef, elClasses: [
                'fc-timegrid-col',
                ...(props.extraClassNames || []),
            ], elAttrs: Object.assign({ role: 'gridcell' }, props.extraDataAttrs), date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, extraRenderProps: props.extraRenderProps }, (InnerContent) => ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: "fc-timegrid-col-frame" },
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: "fc-timegrid-col-bg" },
                this.renderFillSegs(props.businessHourSegs, 'non-business'),
                this.renderFillSegs(props.bgEventSegs, 'bg-event'),
                this.renderFillSegs(props.dateSelectionSegs, 'highlight')),
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: "fc-timegrid-col-events" }, this.renderFgSegs(sortedFgSegs, interactionAffectedInstances, false, false, false)),
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: "fc-timegrid-col-events" }, this.renderFgSegs(mirrorSegs, {}, Boolean(props.eventDrag), Boolean(props.eventResize), Boolean(isSelectMirror))),
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: "fc-timegrid-now-indicator-container" }, this.renderNowIndicator(props.nowIndicatorSegs)),
            (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cn)(options) && ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(InnerContent, { elTag: "div", elClasses: ['fc-timegrid-col-misc'] }))))));
    }
    ...
    segIsInvisible, isDragging, isResizing, isDateSelecting) {
        ...
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.Fragment, null,
            ...
            segPlacements.map((segPlacement) => {
                ...
                return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: 'fc-timegrid-event-harness' +
                    ...
                    (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(TimeColEvent, Object.assign({ seg: seg, isDragging: isDragging, isResizing: isResizing, isDateSelecting: isDateSelecting, isSelected: instanceId === eventSelection, isShort: isShort }, (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bS)(seg, todayRange, nowDate)))));
            })));
    }
    // will already have eventMinHeight applied because segInputs already had it
    renderHiddenGroups(hiddenGroups, segs) {
        let { extraDateSpan, dateProfile, todayRange, nowDate, eventSelection, eventDrag, eventResize } = this.props;
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, hiddenGroups.map((hiddenGroup) => {
            let positionCss = computeSegVStyle(hiddenGroup.span);
            let hiddenSegs = compileSegsFromEntries(hiddenGroup.entries, segs);
            return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(TimeColMoreLink, { key: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bx)((0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.ct)(hiddenSegs)), hiddenSegs: hiddenSegs, top: positionCss.top, bottom: positionCss.bottom, extraDateSpan: extraDateSpan, dateProfile: dateProfile, todayRange: todayRange, nowDate: nowDate, eventSelection: eventSelection, eventDrag: eventDrag, eventResize: eventResize }));
        })));
    }
    renderFillSegs(segs, fillType) {
        let { props, context } = this;
        ...
        let children = segVCoords.map((vcoords, i) => {
            let seg = segs[i];
            return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { key: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bT)(seg.eventRange), className: "fc-timegrid-bg-harness", style: computeSegVStyle(vcoords) }, fillType === 'bg-event' ?
                (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cq, Object.assign({ seg: seg }, (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bS)(seg, props.todayRange, props.nowDate))) :
                (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cp)(fillType)));
        });
        return (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, children);
    }
    renderNowIndicator(segs) {
        ...
        return segs.map((seg, i) => ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cl
...
function renderPlainFgSegs(sortedFgSegs, { todayRange, nowDate, eventSelection, eventDrag, eventResize }) {
    let hiddenInstances = (eventDrag ? eventDrag.affectedInstances : null) ||
        ...
        {};
    return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, sortedFgSegs.map((seg) => {
        let instanceId = seg.eventRange.instance.instanceId;
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { key: instanceId, style: { visibility: hiddenInstances[instanceId] ? 'hidden' : '' } },
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(TimeColEvent, Object.assign({ seg: seg, isDragging: false, isResizing: false, isDateSelecting: false, isSelected: instanceId === eventSelection, isShort: false }, (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bS)(seg, todayRange, nowDate)))));
    })));
}
...
class TimeColsContent extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.N {
    constructor() {
        super(...arguments);
        this.splitFgEventSegs = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.j)(splitSegsByCol);
        this.splitBgEventSegs = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.j)(splitSegsByCol);
        this.splitBusinessHourSegs = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.j)(splitSegsByCol);
        this.splitNowIndicatorSegs = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.j)(splitSegsByCol);
        this.splitDateSelectionSegs = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.j)(splitSegsByCol);
        this.splitEventDrag = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.j)(splitInteractionByCol);
        this.splitEventResize = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.j)(splitInteractionByCol);
        this.rootElRef = (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createRef)();
        this.cellElRefs = new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cg();
    }
    render() {
        let { props, context } = this;
        ...
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: "fc-timegrid-cols", ref: this.rootElRef },
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("table", { role: "presentation", style: {
                    minWidth: props.tableMinWidth,
                    width: props.clientWidth,
                } },
                props.tableColGroupNode,
                (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("tbody", { role: "presentation" },
                    (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("tr", { role: "row" },
                        props.axis && ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("td", { "aria-hidden": true, className: "fc-timegrid-col fc-timegrid-axis" },
                            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: "fc-timegrid-col-frame" },
                                (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: "fc-timegrid-now-indicator-container" }, typeof nowIndicatorTop === 'number' && ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cl, { elClasses: ['fc-timegrid-now-indicator-arrow'], elStyle: { top: nowIndicatorTop }, isAxis: true, date: props.nowDate })))))),
                        props.cells.map((cell, i) => ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(TimeCol, { key: cell.key, elRef: this.cellElRefs.createRef(cell.key), dateProfile: props.dateProfile, date: cell.date, nowDate: props.nowDate, todayRange: props.todayRange, extraRenderProps: cell.extraRenderProps, extraDataAttrs: cell.extraDataAttrs, extraClassNames: cell.extraClassNames, extraDateSpan: cell.extraDateSpan, fgEventSegs: fgEventSegsByRow[i], bgEventSegs: bgEventSegsByRow[i], businessHourSegs: businessHourSegsByRow[i], nowIndicatorSegs: nowIndicatorSegsByRow[i], dateSelectionSegs: dateSelectionSegsByRow[i], eventDrag: eventDragByRow[i], eventResize: eventResizeByRow[i], slatCoords: props.slatCoords, eventSelection: props.eventSelection, forPrint: props.forPrint }))))))));
    }
    componentDidMount() {
        this.updateCoords();
    }
    ...
    updateCoords() {
        ...
        if (props.onColCoords &&
            ...
            props.onColCoords(new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.b9(this.rootElRef.current, collectCellEls(this.cellElRefs.currentMap, props.cells), true, // horizontal
            false));
        }
    }
}
...
----------------------------------------------------------------------------------------------------------------------*/
class TimeCols extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bd {
    constructor() {
        super(...arguments);
        this.processSlotOptions = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.j)(processSlotOptions);
        this.state = {
            slatCoords: null,
        };
        this.handleRootEl = (el) => {
    ...
    render() {
        let { props, state } = this;
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: "fc-timegrid-body", ref: this.handleRootEl, style: {
                // these props are important to give this wrapper correct dimensions for interactions
                // TODO: if we set it here, can we avoid giving to inner tables?
                width: props.clientWidth,
                minWidth: props.tableMinWidth,
            } },
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(TimeColsSlats, { axis: props.axis, dateProfile: props.dateProfile, slatMetas: props.slatMetas, clientWidth: props.clientWidth, minHeight: props.expandRows ? props.clientHeight : '', tableMinWidth: props.tableMinWidth, tableColGroupNode: props.axis ? props.tableColGroupNode : null /* axis depends on the colgroup's shrinking */, onCoords: this.handleSlatCoords }),
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(TimeColsContent, { cells: props.cells, axis: props.axis, dateProfile: props.dateProfile, businessHourSegs: props.businessHourSegs, bgEventSegs: props.bgEventSegs, fgEventSegs: props.fgEventSegs, dateSelectionSegs: props.dateSelectionSegs, eventSelection: props.eventSelection, eventDrag: props.eventDrag, eventResize: props.eventResize, todayRange: props.todayRange, nowDate: props.nowDate, nowIndicatorSegs: props.nowIndicatorSegs, clientWidth: props.clientWidth, tableMinWidth: props.tableMinWidth, tableColGroupNode: props.tableColGroupNode, slatCoords: state.slatCoords, onColCoords: this.handleColCoords, forPrint: props.forPrint })));
    }
    componentDidMount() {
    ...
    queryHit(positionLeft, positionTop) {
        ...
        if (colIndex != null && slatIndex != null) {
            ...
            let time = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bq)(dateProfile.slotMinTime, (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bp)(snapDuration, snapIndex));
...
function processSlotOptions(slotDuration, snapDurationOverride) {
    ...
    let snapsPerSlot = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bu)(slotDuration, snapDuration);
...
class DayTimeColsSlicer extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bW {
    sliceRange(range, dayRanges) {
        let segs = [];
        for (let col = 0; col < dayRanges.length; col += 1) {
            let segRange = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.b5)(range, dayRanges[col]);
            if (segRange) {
                segs.push({
                    start: segRange.start,
                    end: segRange.end,
...
class DayTimeCols extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bd {
    constructor() {
        super(...arguments);
        this.buildDayRanges = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.j)(buildDayRanges);
        this.slicer = new DayTimeColsSlicer();
        this.timeColsRef = (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createRef)();
    }
    render() {
        let { props, context } = this;
...
function buildSlatMetas(slotMinTime, slotMaxTime, explicitLabelInterval, slotDuration, dateEnv) {
    ...
    let slatIterator = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.d)(0);
    let labelInterval = explicitLabelInterval || computeLabelInterval(slotDuration);
    let metas = [];
    while ((0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bt)(slatTime) < (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bt)(slotMaxTime)) {
        let date = dateEnv.add(dayStart, slatTime);
        let isLabeled = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bu)(slatIterator, labelInterval) !== null;
        metas.push({
            date,
            time: slatTime,
            key: date.toISOString(),
            isoTimeStr: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bv)(date),
            isLabeled,
        });
        slatTime = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bq)(slatTime, slotDuration);
        slatIterator = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bq)(slatIterator, slotDuration);
    }
    return metas;
}
...
function computeLabelInterval(slotDuration) {
    ...
    for (i = STOCK_SUB_DURATIONS.length - 1; i >= 0; i -= 1) {
        labelInterval = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.d)(STOCK_SUB_DURATIONS[i]);
        slotsPerLabel = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bu)(labelInterval, slotDuration);
...
class DayTimeColsView extends TimeColsView {
    constructor() {
        super(...arguments);
        this.buildTimeColsModel = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.j)(buildTimeColsModel);
        this.buildSlatMetas = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.j)(buildSlatMetas);
    }
    render() {
        ...
        let headerContent = options.dayHeaders && ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bK, { dates: dayTableModel.headerDates, dateProfile: dateProfile, datesRepDistinctDays: true, renderIntro: hasAttachedAxis ? this.renderHeadAxis : null }));
        let allDayContent = (options.allDaySlot !== false) && ((contentArg) => ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@fullcalendar/daygrid/internal.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), Object.assign({}, splitProps.allDay, { dateProfile: dateProfile, dayTableModel: dayTableModel, nextDayThreshold: options.nextDayThreshold, tableMinWidth: contentArg.tableMinWidth, colGroupNode: contentArg.tableColGroupNode, renderRowIntro: hasAttachedAxis ? this.renderTableRowAxis : null, showWeekNumbers: false, expandRows: false, headerAlignElRef: this.headerElRef, clientWidth: contentArg.clientWidth, clientHeight: contentArg.clientHeight, forPrint: props.forPrint }, this.getAllDayMaxEventProps()))));
        let timeGridContent = (contentArg) => ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(DayTimeCols, Object.assign({}, splitProps.timed, { dayTableModel: dayTableModel, dateProfile: dateProfile, axis: hasAttachedAxis, slotDuration: options.slotDuration, slatMetas: slatMetas, forPrint: props.forPrint, tableColGroupNode: contentArg.tableColGroupNode, tableMinWidth: contentArg.tableMinWidth, clientWidth: contentArg.clientWidth, clientHeight: contentArg.clientHeight, onSlatCoords: this.handleSlatCoords, expandRows: contentArg.expandRows, onScrollTopRequest: this.handleScrollTopRequest })));
...
function buildTimeColsModel(dateProfile, dateProfileGenerator) {
    let daySeries = new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bO(dateProfile.renderRange, dateProfileGenerator);
    return new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bV(daySeries, false);
}
...
/* harmony export */ });
/* harmony import */ var _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @fullcalendar/core/internal.js */ "./node_modules/@fullcalendar/core/internal-common.js");
Object(function webpackMissingModule() { var e = new Error("Cannot find module '@fullcalendar/premium-common/index.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var _internal_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./internal.js */ "./node_modules/@fullcalendar/timeline/internal.js");
Object(function webpackMissingModule() { var e = new Error("Cannot find module '@fullcalendar/scrollgrid/internal.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
var index = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.a8)({
    ...
    deps: [Object(function webpackMissingModule() { var e = new Error("Cannot find module '@fullcalendar/premium-common/index.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())],
...
_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bI.MAX_TIMELINE_SLOTS = 1000;
...
function buildTimelineDateProfile(dateProfile, dateEnv, allOptions, dateProfileGenerator) {
    ...
    tDateProfile.headerFormats = rawFormats.map((rawFormat) => (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.e)(rawFormat));
    tDateProfile.isTimeScale = Boolean(tDateProfile.slotDuration.milliseconds);
    let largeUnit = null;
    if (!tDateProfile.isTimeScale) {
        const slotUnit = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.c)(tDateProfile.slotDuration).unit;
    ...
    tDateProfile.emphasizeWeeks =
        (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bo)(tDateProfile.slotDuration) === 1 &&
    ...
    */
    ...
    let snapsPerSlot;
    if (rawSnapDuration) {
        snapDuration = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.d)(rawSnapDuration);
        snapsPerSlot = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bu)(tDateProfile.slotDuration, snapDuration);
    ...
    // more...
    let timeWindowMs = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bt)(dateProfile.slotMaxTime) - (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bt)(dateProfile.slotMinTime);
    ...
    if (tDateProfile.isTimeScale) {
        ...
        normalizedEnd = dateEnv.add((0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bf)(normalizedEnd, -1), dateProfile.slotMaxTime);
    }
    ...
    tDateProfile.slotsPerLabel = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bu)(tDateProfile.labelInterval, tDateProfile.slotDuration);
    return tDateProfile;
}
/*
...
function normalizeDate(date, tDateProfile, dateEnv) {
    let normalDate = date;
    if (!tDateProfile.isTimeScale) {
        normalDate = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bg)(normalDate);
...
function normalizeRange(range, tDateProfile, dateEnv) {
    if (!tDateProfile.isTimeScale) {
        range = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.at)(range);
        if (tDateProfile.largeUnit) {
...
function isValidDate(date, tDateProfile, dateProfile, dateProfileGenerator) {
    ...
    if (tDateProfile.isTimeScale) {
        ...
        let day = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bg)(date);
        let timeMs = date.valueOf() - day.valueOf();
        let ms = timeMs - (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bt)(dateProfile.slotMinTime); // milliseconds since slotMinTime
...
function validateLabelAndSlot(tDateProfile, dateProfile, dateEnv) {
    ...
    if (tDateProfile.labelInterval) {
        ...
        if (labelCnt > _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bI.MAX_TIMELINE_SLOTS) {
    ...
    if (tDateProfile.slotDuration) {
        ...
        if (slotCnt > _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bI.MAX_TIMELINE_SLOTS) {
    ...
    if (tDateProfile.labelInterval && tDateProfile.slotDuration) {
        const slotsPerLabel = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bu)(tDateProfile.labelInterval, tDateProfile.slotDuration);
        if (slotsPerLabel === null || slotsPerLabel < 1) {
    ...
    if (!labelInterval) {
        ...
        if (tDateProfile.slotDuration) {
            for (input of STOCK_SUB_DURATIONS) {
                const tryLabelInterval = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.d)(input);
                const slotsPerLabel = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bu)(tryLabelInterval, tDateProfile.slotDuration);
            ...
            for (input of STOCK_SUB_DURATIONS) {
                labelInterval = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.d)(input);
...
function ensureSlotDuration(tDateProfile, dateProfile, dateEnv) {
    ...
    if (!slotDuration) {
        ...
        for (let input of STOCK_SUB_DURATIONS) {
            const trySlotDuration = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.d)(input);
            const slotsPerLabel = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bu)(labelInterval, trySlotDuration);
...
function computeHeaderFormats(tDateProfile, dateProfile, dateEnv, allOptions) {
    ...
    let unit = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.c)(labelInterval).unit;
    ...
    switch (unit) {
        ...
        case 'minute':
            ...
            if (((0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.br)(labelInterval) / 60) >= MAX_AUTO_SLOTS_PER_LABEL) {
                format0 = {
                    hour: 'numeric',
                    meridiem: 'short',
                };
                format1 = (params) => (':' + (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.ag)(params.date.minute, 2) // ':30'
                );
            }
            else {
                format0 = {
        ...
        case 'second':
            ...
            if (((0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bs)(labelInterval) / 60) >= MAX_AUTO_SLOTS_PER_LABEL) {
                format0 = { hour: 'numeric', minute: '2-digit', meridiem: 'lowercase' }; // '8:30 PM'
                format1 = (params) => (':' + (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.ag)(params.date.second, 2) // ':30'
                );
            }
            else {
        ...
        case 'millisecond':
            format0 = { hour: 'numeric', minute: '2-digit', second: '2-digit', meridiem: 'lowercase' }; // '8:30:45 PM'
            format1 = (params) => ('.' + (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.ag)(params.millisecond, 3));
            break;
    }
...
function currentRangeAs(unit, dateProfile, dateEnv) {
    ...
    if (unit === 'years') {
        ...
        res = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.h)(range.start, range.end);
    }
    return res || 0;
}
...
function buildCellRows(tDateProfile, dateEnv) {
    ...
    let slotAsDays = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bo)(tDateProfile.slotDuration);
    ...
    for (let i = 0; i < slotDates.length; i += 1) {
        ...
        for (let row = 0; row < formats.length; row += 1) {
            ...
            if (isSuperRow) {
                ...
                (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.ah)(dateEnv.countDurationsBetween(tDateProfile.normalizedRange.start, date, tDateProfile.labelInterval))) {
                let text = dateEnv.format(date, format);
                newCell = buildCellObject(date, text, rowUnit);
            }
            else {
...
class TimelineHeaderTh extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.N {
    constructor() {
        super(...arguments);
        this.refineRenderProps = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.l)(refineRenderProps);
        this.buildCellNavLinkAttrs = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.j)(buildCellNavLinkAttrs);
    }
    render() {
        let { props, context } = this;
        let { dateEnv, options } = context;
        ...
        let dateMeta = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.aX)(cell.date, props.todayRange, props.nowDate, dateProfile);
        let renderProps = this.refineRenderProps({
        ...
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.C, { elTag: "th", elClasses: [
                'fc-timeline-slot',
                'fc-timeline-slot-label',
                cell.isWeekStart && 'fc-timeline-slot-em',
                ...( // TODO: so slot classnames for week/month/bigger. see note above about rowUnit
                cell.rowUnit === 'time' ?
                    (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.aY)(dateMeta, context.theme) :
                    (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.aW)(dateMeta, context.theme)),
            ], elAttrs: {
            ...
            }, renderProps: renderProps, generatorName: "slotLabelContent", generator: options.slotLabelContent || renderInnerContent, classNameGenerator: options.slotLabelClassNames, didMount: options.slotLabelDidMount, willUnmount: options.slotLabelWillUnmount }, (InnerContent) => ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: "fc-timeline-slot-frame", style: { height: props.rowInnerHeight } },
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(InnerContent, { elTag: "a", elClasses: [
...
function buildCellNavLinkAttrs(context, cellDate, rowUnit) {
    return (rowUnit && rowUnit !== 'time')
        ? (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.aZ)(context, cellDate, rowUnit)
        : {};
}
function renderInnerContent(renderProps) {
    return renderProps.text;
...
class TimelineHeaderRows extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.N {
    render() {
        let { dateProfile, tDateProfile, rowInnerHeights, todayRange, nowDate } = this.props;
        let { cellRows } = tDateProfile;
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, cellRows.map((rowCells, rowLevel) => {
            ...
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("tr", { key: rowLevel, className: classNames.join(' ') }, rowCells.map((cell) => ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(TimelineHeaderTh, { key: cell.date.toISOString(), cell: cell, rowLevel: rowLevel, dateProfile: dateProfile, tDateProfile: tDateProfile, todayRange: todayRange, nowDate: nowDate, rowInnerHeight: rowInnerHeights && rowInnerHeights[rowLevel], isSticky: !isLast })))));
        })));
    }
}
...
class TimelineCoords {
    ...
    slatEls, dateProfile, tDateProfile, dateEnv, isRtl) {
        ...
        this.dateEnv = dateEnv;
        this.isRtl = isRtl;
        this.outerCoordCache = new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.b9(slatRootEl, slatEls, true, // isHorizontal
        false);
        // for the inner divs within the slats
        // used for event rendering and scrollTime, to disregard slat border
        this.innerCoordCache = new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.b9(slatRootEl, (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.aJ)(slatEls, 'div'), true, // isHorizontal
        false);
    }
    isDateInRange(date) {
        return (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.r)(this.dateProfile.currentRange, date);
    }
    ...
    durationToCoord(duration) {
        ...
        if (dateProfile) {
            ...
            if (!tDateProfile.isTimeScale) {
                date = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bg)(date);
            }
...
function computeDateSnapCoverage(date, tDateProfile, dateEnv) {
    ...
    if ((0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.ah)(snapCoverage)) { // not an in-between value
...
class TimelineHeader extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.N {
    constructor() {
        super(...arguments);
        this.rootElRef = (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createRef)();
    }
    render() {
        ...
        let timerUnit = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.c)(props.tDateProfile.slotDuration).unit;
        // WORKAROUND: make ignore slatCoords when out of sync with dateProfile
        let slatCoords = props.slatCoords && props.slatCoords.dateProfile === props.dateProfile ? props.slatCoords : null;
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.ci, { unit: timerUnit }, (nowDate, todayRange) => ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: "fc-timeline-header", ref: this.rootElRef },
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("table", { "aria-hidden": true, className: "fc-scrollgrid-sync-table", style: { minWidth: props.tableMinWidth, width: props.clientWidth } },
                props.tableColGroupNode,
                (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("tbody", null,
                    (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(TimelineHeaderRows, { dateProfile: props.dateProfile, tDateProfile: props.tDateProfile, nowDate: nowDate, todayRange: todayRange, rowInnerHeights: props.rowInnerHeights }))),
            context.options.nowIndicator && (
            // need to have a container regardless of whether the current view has a visible now indicator
            // because apparently removal of the element resets the scroll for some reasons (issue #5351).
            // this issue doesn't happen for the timeline body however (
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: "fc-timeline-now-indicator-container" }, (slatCoords && slatCoords.isDateInRange(nowDate)) && ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cl, { elClasses: ['fc-timeline-now-indicator-arrow'], elStyle: coordToCss(slatCoords.dateToCoord(nowDate), context.isRtl), isAxis: true, date: nowDate }))))))));
    }
    componentDidMount() {
        this.updateSize();
    }
    ...
    computeMaxCushionWidth() {
        return Math.max(...(0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.aI)(this.rootElRef.current, '.fc-timeline-header-row:last-child .fc-timeline-slot-cushion').map((el) => el.getBoundingClientRect().width));
    }
}

class TimelineSlatCell extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.N {
    render() {
        let { props, context } = this;
        let { dateEnv, options, theme } = context;
        let { date, tDateProfile, isEm } = props;
        let dateMeta = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.aX)(props.date, props.todayRange, props.nowDate, props.dateProfile);
        let renderProps = Object.assign(Object.assign({ date: dateEnv.toDate(props.date) }, dateMeta), { view: context.viewApi });
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.C, { elTag: "td", elRef: props.elRef, elClasses: [
                'fc-timeline-slot',
                'fc-timeline-slot-lane',
                isEm && 'fc-timeline-slot-em',
                tDateProfile.isTimeScale ? ((0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.ah)(dateEnv.countDurationsBetween(tDateProfile.normalizedRange.start, props.date, tDateProfile.labelInterval)) ?
                    'fc-timeline-slot-major' :
                    'fc-timeline-slot-minor') : '',
                ...(props.isDay ?
                    (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.aW)(dateMeta, theme) :
                    (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.aY)(dateMeta, theme)),
            ], elAttrs: {
                'data-date': dateEnv.formatIso(date, {
                    omitTimeZoneOffset: true,
                    omitTime: !tDateProfile.isTimeScale,
                }),
            }, renderProps: renderProps, generatorName: "slotLaneContent", generator: options.slotLaneContent, classNameGenerator: options.slotLaneClassNames, didMount: options.slotLaneDidMount, willUnmount: options.slotLaneWillUnmount }, (InnerContent) => ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(InnerContent, { elTag: "div" }))));
    }
}

class TimelineSlatsBody extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.N {
    render() {
        let { props } = this;
        let { tDateProfile, cellElRefs } = props;
        let { slotDates, isWeekStarts } = tDateProfile;
        let isDay = !tDateProfile.isTimeScale && !tDateProfile.largeUnit;
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("tbody", null,
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("tr", null, slotDates.map((slotDate, i) => {
                let key = slotDate.toISOString();
                return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(TimelineSlatCell, { key: key, elRef: cellElRefs.createRef(key), date: slotDate, dateProfile: props.dateProfile, tDateProfile: tDateProfile, nowDate: props.nowDate, todayRange: props.todayRange, isEm: isWeekStarts[i], isDay: isDay }));
            }))));
    }
}

class TimelineSlats extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.N {
    constructor() {
        super(...arguments);
        this.rootElRef = (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createRef)();
        this.cellElRefs = new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cg();
    ...
    render() {
        let { props, context } = this;
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: "fc-timeline-slots", ref: this.rootElRef },
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("table", { "aria-hidden": true, className: context.theme.getClass('table'), style: {
                    minWidth: props.tableMinWidth,
                    width: props.clientWidth,
                } },
                props.tableColGroupNode,
                (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(TimelineSlatsBody, { cellElRefs: this.cellElRefs, dateProfile: props.dateProfile, tDateProfile: props.tDateProfile, nowDate: props.nowDate, todayRange: props.todayRange }))));
    }
    componentDidMount() {
        this.updateSizing();
        this.scrollResponder = this.context.createScrollResponder(this.handleScrollRequest);
    ...
    positionToHit(leftPosition) {
        ...
        if (slatIndex != null) {
            ...
            let start = dateEnv.add(tDateProfile.slotDates[slatIndex], (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bp)(tDateProfile.snapDuration, localSnapIndex));
...
strictOrder, maxStackCnt) {
    ...
    for (let i = 0; i < hiddenGroups.length; i += 1) {
        ...
        let height = moreLinkHeights[(0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bx)((0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.ct)(sortedSegs))]; // not optimal :(
        if (height != null) {
...
class TimelineLaneBg extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.N {
    render() {
        let { props } = this;
        let highlightSeg = [].concat(props.eventResizeSegs, props.dateSelectionSegs);
        return props.timelineCoords && ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: "fc-timeline-bg" },
    ...
    renderSegs(segs, timelineCoords, fillType) {
        ...
        let children = segs.map((seg, i) => {
            ...
            return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { key: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bT)(seg.eventRange), className: "fc-timeline-bg-harness", style: hStyle }, fillType === 'bg-event' ?
                (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cq, Object.assign({ seg: seg }, (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bS)(seg, todayRange, nowDate))) :
                (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cp)(fillType)));
        });
        return (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, children);
    }
...
class TimelineLaneSlicer extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bW {
    sliceRange(origRange, dateProfile, dateProfileGenerator, tDateProfile, dateEnv) {
        ...
        if (computeDateSnapCoverage(normalRange.start, tDateProfile, dateEnv)
            ...
            let slicedRange = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.b5)(normalRange, tDateProfile.normalizedRange);
            if (slicedRange) {
                segs.push({
                    ...
                    isEnd: slicedRange.end.valueOf() === normalRange.end.valueOf()
                        && isValidDate((0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bh)(slicedRange.end, -1), tDateProfile, dateProfile, dateProfileGenerator),
                });
            }
        }
        return segs;
...
class TimelineEvent extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.N {
    render() {
        let { props } = this;
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.ck, Object.assign({}, props, { elClasses: ['fc-timeline-event', 'fc-h-event'], defaultTimeFormat: DEFAULT_TIME_FORMAT, defaultDisplayEventTime: !props.isTimeScale })));
    }
}

class TimelineLaneMoreLink extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.N {
    render() {
        let { props, context } = this;
        ...
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cs, { elRef: props.elRef, elClasses: ['fc-timeline-more-link'], elStyle: Object.assign({ visibility: isVisible ? '' : 'hidden', top: top || 0 }, hStyle), allDayDate: null, moreCnt: hiddenSegs.length, allSegs: hiddenSegs, hiddenSegs: hiddenSegs, dateProfile: props.dateProfile, todayRange: props.todayRange, extraDateSpan: extraDateSpan, popoverContent: () => ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, hiddenSegs.map((seg) => {
                let instanceId = seg.eventRange.instance.instanceId;
                return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { key: instanceId, style: { visibility: props.isForcedInvisible[instanceId] ? 'hidden' : '' } },
                    (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(TimelineEvent, Object.assign({ isTimeScale: props.isTimeScale, seg: seg, isDragging: false, isResizing: false, isDateSelecting: false, isSelected: instanceId === props.eventSelection }, (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bS)(seg, props.todayRange, props.nowDate)))));
            }))) }, (InnerContent) => ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(InnerContent, { elTag: "div", elClasses: ['fc-timeline-more-link-inner', 'fc-sticky'] }))));
    }
}

class TimelineLane extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.N {
    constructor() {
        super(...arguments);
        this.slicer = new TimelineLaneSlicer();
        this.sortEventSegs = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.j)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bR);
        this.harnessElRefs = new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cg();
        this.moreElRefs = new _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cg();
        this.innerElRef = (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createRef)();
    ...
    render() {
        ...
        let isForcedInvisible = // TODO: more convenient
         (slicedProps.eventDrag ? slicedProps.eventDrag.affectedInstances : null) ||
            ...
            {};
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.Fragment, null,
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(TimelineLaneBg, { businessHourSegs: slicedProps.businessHourSegs, bgEventSegs: slicedProps.bgEventSegs, timelineCoords: props.timelineCoords, eventResizeSegs: slicedProps.eventResize ? slicedProps.eventResize.segs : [] /* bad new empty array? */, dateSelectionSegs: slicedProps.dateSelectionSegs, nowDate: props.nowDate, todayRange: props.todayRange }),
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: "fc-timeline-events fc-scrollgrid-sync-inner", ref: this.innerElRef, style: { height: fgHeight } },
    ...
    updateSize() {
        ...
        if (timelineCoords) {
            this.setState({
                eventInstanceHeights: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.a)(this.harnessElRefs.currentMap, (harnessEl) => (Math.round(harnessEl.getBoundingClientRect().height))),
                moreLinkHeights: (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.a)(this.moreElRefs.currentMap, (moreEl) => (Math.round(moreEl.getBoundingClientRect().height))),
            }, () => {
                if (props.onHeightChange) {
    ...
    renderFgSegs(segPlacements, isForcedInvisible, isDragging, isResizing, isDateSelecting) {
        ...
        let isMirror = isDragging || isResizing || isDateSelecting;
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, segPlacements.map((segPlacement) => {
            let { seg, hcoords, top } = segPlacement;
            if (Array.isArray(seg)) { // a more-link
                let isoStr = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bx)((0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.ct)(seg));
                return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(TimelineLaneMoreLink, { key: 'm:' + isoStr /* "m" for "more" */, elRef: moreElRefs.createRef(isoStr), hiddenSegs: seg, placement: segPlacement, dateProfile: props.dateProfile, nowDate: props.nowDate, todayRange: props.todayRange, isTimeScale: props.tDateProfile.isTimeScale, eventSelection: props.eventSelection, resourceId: props.resourceId, isForcedInvisible: isForcedInvisible }));
            }
            let instanceId = seg.eventRange.instance.instanceId;
            let isVisible = isMirror || Boolean(!isForcedInvisible[instanceId] && hcoords && top !== null);
            let hStyle = coordsToCss(hcoords, context.isRtl);
            return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { key: 'e:' + instanceId /* "e" for "event" */, ref: isMirror ? null : harnessElRefs.createRef(instanceId), className: "fc-timeline-event-harness", style: Object.assign({ visibility: isVisible ? '' : 'hidden', top: top || 0 }, hStyle) },
                (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(TimelineEvent, Object.assign({ isTimeScale: props.tDateProfile.isTimeScale, seg: seg, isDragging: isDragging, isResizing: isResizing, isDateSelecting: isDateSelecting, isSelected: instanceId === props.eventSelection /* TODO: bad for mirror? */ }, (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bS)(seg, props.todayRange, props.nowDate)))));
        })));
    }
}
TimelineLane.addStateEquality({
    eventInstanceHeights: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.n,
    moreLinkHeights: _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.n,
});
...
class TimelineGrid extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bd {
    constructor() {
        super(...arguments);
        this.slatsRef = (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createRef)();
        this.state = {
            coords: null,
        };
        this.handeEl = (el) => {
    ...
    render() {
        ...
        let { options } = context;
        let { dateProfile, tDateProfile } = props;
        let timerUnit = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.c)(tDateProfile.slotDuration).unit;
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: "fc-timeline-body", ref: this.handeEl, style: {
                minWidth: props.tableMinWidth,
                height: props.clientHeight,
                width: props.clientWidth,
            } },
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.ci, { unit: timerUnit }, (nowDate, todayRange) => ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.Fragment, null,
                (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(TimelineSlats, { ref: this.slatsRef, dateProfile: dateProfile, tDateProfile: tDateProfile, nowDate: nowDate, todayRange: todayRange, clientWidth: props.clientWidth, tableColGroupNode: props.tableColGroupNode, tableMinWidth: props.tableMinWidth, onCoords: this.handleCoords, onScrollLeftRequest: props.onScrollLeftRequest }),
                (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(TimelineLane, { dateProfile: dateProfile, tDateProfile: props.tDateProfile, nowDate: nowDate, todayRange: todayRange, nextDayThreshold: options.nextDayThreshold, businessHours: props.businessHours, eventStore: props.eventStore, eventUiBases: props.eventUiBases, dateSelection: props.dateSelection, eventSelection: props.eventSelection, eventDrag: props.eventDrag, eventResize: props.eventResize, timelineCoords: state.coords, syncParentMinHeight: true }),
                (options.nowIndicator && state.coords && state.coords.isDateInRange(nowDate)) && ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", { className: "fc-timeline-now-indicator-container" },
                    (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cl, { elClasses: ['fc-timeline-now-indicator-line'], elStyle: coordToCss(state.coords.dateToCoord(nowDate), context.isRtl), isAxis: false, date: nowDate }))))))));
    }
    // Hit System
    // ------------------------------------------------------------------------------------------
    queryHit(positionLeft, positionTop, elWidth, elHeight) {
...
class TimelineView extends _fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.bd {
    constructor() {
        super(...arguments);
        this.buildTimelineDateProfile = (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.j)(buildTimelineDateProfile);
        this.scrollGridRef = (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createRef)();
        this.state = {
            slatCoords: null,
    ...
    render() {
        let { props, state, context } = this;
        let { options } = context;
        let stickyHeaderDates = !props.forPrint && (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cd)(options);
        let stickyFooterScrollbar = !props.forPrint && (0,_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cc)(options);
        ...
        return ((0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(_fullcalendar_core_internal_js__WEBPACK_IMPORTED_MODULE_1__.cu, { elClasses: [
                'fc-timeline',
                options.eventOverlap === false ?
                    'fc-timeline-overlap-disabled' :
                    '',
            ], viewSpec: context.viewSpec },
            (0,_fullcalendar_core_preact_js__WEBPACK_IMPORTED_MODULE_2__.createElement)(Object(function webpackMissingModule() { var e = new Error("Cannot find module '@fullcalendar/scrollgrid/internal.js'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), { ref: this.scrollGridRef, liquid: !props.isHeightAuto && !props.forPrint, collapsibleWidth: false, colGroups: [
                    { cols: slatCols },
                ], sections: sections })));
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Calendar": function() { return /* reexport safe */ _fullcalendar_core__WEBPACK_IMPORTED_MODULE_5__.Calendar; },
...
/* harmony import */ var _fullcalendar_timeline__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @fullcalendar/timeline */ "./node_modules/@fullcalendar/timeline/index.js");
...
var calendarPlugins = {
  ...
  timeline: _fullcalendar_timeline__WEBPACK_IMPORTED_MODULE_4__["default"]
};
